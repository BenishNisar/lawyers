					...
					<div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 pull-right service_page_main_post ">
						<div class="wrapper">
							...
							<div class="main_img_holder">
								<img src="{{ asset("assets/images/home/awarbanner.jpg") }}" alt="image" class="img-responsive">
								<h4 class="p_color_bg s_color">Exit & Succession Planning</h4>
...
<div class="law-card-grid">
  ...
  <article class="law-card">
    <div class="corner-lines top"><span></span><span></span></div>

    <div class="emblem">
      <!-- inline courthouse + laurel (no external icon libs) -->
      <svg viewBox="0 0 64 32" aria-hidden="true">
        <g fill="currentColor">
          <rect x="12" y="14" width="40" height="3" rx="1.5"/>
          <rect x="18" y="18" width="6" height="7" rx="1"/>
          <rect x="29" y="18" width="6" height="7" rx="1"/>
          <rect x="40" y="18" width="6" height="7" rx="1"/>
          <rect x="14" y="26" width="36" height="2" rx="1"/>
          <path d="M32 3 14 10h36L32 3Z"/>
          <!-- simple laurel -->
          <path d="M9 11c-2 3-2 6 1 9 3-1 4-3 4-6-2-1-3-2-5-3Z"/>
          <path d="M55 11c2 3 2 6-1 9-3-1-4-3-4-6 2-1 3-2 5-3Z"/>
        </g>
      </svg>
    </div>
    <h3 class="brand">ABDUL AZIZ ISMAIL</h3>
    ...
    <div class="name">Education : B.Com L.L.B</div>
    <div class="role">Sindh Bar Association</div>
        <div class="role">Karachi Bar Association</div>

    <div class="role">Income Tax Bar Association</div>
            <div class="role">Sales Tax Bar Association</div>

    <div class="id">PRACTICE: Income Tax, Sales Tax and Corporate Law</div>

    <div class="corner-lines bottom"><span></span><span></span></div>
  </article>
  ...
  <article class="law-card">
    ...
    <div class="emblem">
      <svg viewBox="0 0 64 32" aria-hidden="true"><g fill="currentColor">
        <rect x="12" y="14" width="40" height="3" rx="1.5"/>
        <rect x="18" y="18" width="6" height="7" rx="1"/>
        <rect x="29" y="18" width="6" height="7" rx="1"/>
        <rect x="40" y="18" width="6" height="7" rx="1"/>
    ...
    <div class="name">Education: B.Com, L.L.B</div>
        <div class="role">Sindh  Bar Association</div>
          <div class="role">             Sales Tax Bar Association</div>
           <div class="role">        Karachi Bar Association</div>
    <div class="id">PRACTICE: Sales Tax
</div>
  ...
  <article class="law-card">
    ...
    <h3 class="brand">Mr. Shakil A. Aziz:</h3>
...
B.Com, L.L.B</div>
    ...
    <div class="id">    Income Tax, Trade Mark & Copy Right
</div>
