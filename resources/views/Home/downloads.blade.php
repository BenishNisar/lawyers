          ...
          <div class="sidebar_testimonial testimonial sidebar_testimonial_style_two">
            ...
            <div class="slider_wrapper">
              <div class="owl-carousel owl-theme" id="testimonial-sidebar">
                <div class="item"><div class="text p_color_bg"><i>They have got my project on time...</i></div></div>
                <div class="item"><div class="text p_color_bg"><i>ConsultPress over 20 years...</i></div></div>
                <div class="item"><div class="text p_color_bg"><i>They have got my project on time...</i></div></div>
              </div>
            </div>
          </div>
